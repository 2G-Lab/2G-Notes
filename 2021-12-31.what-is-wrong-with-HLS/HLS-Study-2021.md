...
CDN-s built on NGINX servers can also forward client requests to one of the *backup servers*,
...
[RFC-8216](https://datatracker.ietf.org/doc/html/rfc8216#section-3) states as follows:  
